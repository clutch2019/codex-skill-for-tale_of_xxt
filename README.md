...
2026-05-29 更新：强化最终总结阶段的专名校正约束。餐厅、酒吧、文艺作品、酒款、酒厂等名称不再允许概括成“多个餐厅”“几部电影”等泛称；对 2-4 个汉字的短名称和近音/同音 ASR 结果，会要求结合美团、大众点评、豆瓣、Untappd 等外部来源逐一核对，并在最终稿中保留专名核对表、来源链接和置信度。
...
- 餐厅、酒吧、店铺、场馆、酒款、酒厂、文艺作品、人名、品牌名不能概括成“多个餐厅”“几部电影”“一些酒款”。如果 ASR 或豆瓣简介中有名称线索，应逐一列出。
- 对 2-4 个汉字的短名称、听起来像普通词的名称、或上下文别扭的词，要按原始 ASR、近音/同音、拼音、城市/菜系/业态/作品类型等锚点做外部检索。例如“鱼酱 + 炉端烧”应继续核对是否可能是“鱼匠炉端烧”，“鱼腥/鱼清”这类短名也应进入候选表。
- 未确认候选不要删除，保留时间戳、ASR 原文、查询依据和置信度。
...
- 最终稿应包含或体现“专名核对表”：最早时间、ASR 原始写法、校正/推断名称、类别、外部证据、来源链接、置信度。
