...
5. 不要把餐厅、酒吧、店铺、场馆、文艺作品、酒款、酒厂、商品名等专名密集内容概括成“多个餐厅”“几部电影”“一些酒款”等泛称。只要 ASR 或豆瓣简介里出现了名称线索，就必须逐一列出；数量多时用分组表格承载。
6. 只在必要位置引用少量原话；不要大规模逐句复述。
7. 关键名词必须校正：店铺、酒吧、餐厅、厂牌、城市地点优先查大众点评/美团/地图/品牌官网；文艺作品、人名、播客/书影音条目优先查豆瓣；商品/酒款可用品牌官网、电商页、Untappd、RateBeer 等交叉确认。所有外部校正来源在末尾列出链接。
